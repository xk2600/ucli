...
/* Fill out the name and prefix for the command dumping function. */
static void
...
void
ucli_command_dump(const ucli_command_t *this)
{
    unsigned i;
    ...
    for(i=0;
        ...
        i++)
    {
        ucli_param_dump(ucli_command__get_param(this,i));
    }
