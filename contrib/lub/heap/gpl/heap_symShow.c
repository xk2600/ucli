...
extern void sysheap_suppress_leak_detection(void) __WEAK;
extern void sysheap_restore_leak_detection(void) __WEAK;
...
lub_heap_init(const char *file_name)
{
    ...
    if(sysheap_suppress_leak_detection)
    {
    ...
    if(sysheap_restore_leak_detection)
    {
