...
ucli_ptype_method_e
    ucli_ptype_method_resolve(const char *method_name);
const char *
 ...
 *----------------- */
void
    ucli_ptype_delete(ucli_ptype_t *instance);
/**
 ...
 */
char *
    ucli_ptype_validate(const ucli_ptype_t *instance,
                         const char          *text);
/**
 ...
 */
char *
    ucli_ptype_translate(const ucli_ptype_t *instance,
                          const char          *text);
/**
 * This is used to perform parameter auto-completion
 */
char *
    ucli_ptype_word_generator(ucli_ptype_t *instance,
                               const char    *text,
                               unsigned       state);
void
    ucli_ptype_dump(ucli_ptype_t *instance);
/*-----------------
 * attributes 
 *----------------- */
const char *
    ucli_ptype__get_name(const ucli_ptype_t *instance);
const char *
    ucli_ptype__get_text(const ucli_ptype_t *instance);
const char *
    ucli_ptype__get_range(const ucli_ptype_t *instance);
void
    ucli_ptype__set_preprocess(ucli_ptype_t            *instance,
                                ucli_ptype_preprocess_e  preprocess);
void
    ucli_ptype__set_pattern(ucli_ptype_t       *instance,
                             const char          *pattern,
                             ucli_ptype_method_e method);
void
    ucli_ptype__set_text(ucli_ptype_t *instance,
                          const char    *text);
#endif /* _ucli_ptype_h */
/** @} ucli_ptype */
